...
The default behaviour is for any intersecting structure to be included in the zone.
```{r warning=FALSE}
...
required for the CV calculation. This dependency is added and handled
...
# convert the grid to a `stars` object and then `sf` to create polygons from the grid cells
