...
#' 
#' @description Make an approximately circular filter inside of an 'n x n'
#'   matrix.
#' @param size The length of the side of a square matrix. The circular window
#'   has a radius of size/2.
#' @return Matrix with values inside the circle set to 1, the center set to 0,
