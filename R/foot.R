...
#' 
#' The \code{foot} package provides functions to calculate summary statistics
#' of geometric measurements of building footprint polygons. Footprint
#' shapes representing buildings are becoming more widely available by
#' being detected and extracted from very high resolution satellite imagery. Such
...
#' land uses or differences in structure use, socio-economic status, etc.
#' 
#' The \code{foot} package is designed to provide a set of consistent and flexible
#' tools for processing 2D vector representations of buildings. The
