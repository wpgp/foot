...
#' 
#' @export 
fs_area_total <- function(X, index=NULL, unit="ha", col=NULL) UseMethod("fs_area_total")


#' @name fs_area_total
#' @export
fs_area_total.sp <- function(X, index=NULL, unit="ha", col=NULL){
  X <- sf::st_as_sf(X)
...
#' @name fs_area_total
#' @export
fs_area_total.sf <- function(X, index=NULL, unit="ha", col=NULL){
...
fs_area_total_calc <- function(X, index, unit='ha'){
