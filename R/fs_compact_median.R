...
#' @import data.table
#' 
#' @aliases fs_compact_median
#' @rdname fs_compact_median
#' 
#' @export 
fs_compact_median <- function(X, 
                              index=NULL, 
                              unit=NULL, 
                              col=NULL) UseMethod("fs_compact_median")


#' @name fs_compact_median
#' @export
fs_compact_median.sp <- function(X, index=NULL, unit=NULL, col=NULL){
  X <- sf::st_as_sf(X)
  
  result <- fs_compact_median(X, index, unit, col)
  return(result)
}
...
#' @name fs_compact_median
#' @export
fs_compact_median.sf <- function(X, index=NULL, unit=NULL, col=NULL){
  if(!is.null(col)){
    ...
    if(!col %in% names(X)){
      ...
      result <- fs_compact_median_calc(X, index, unit)
    }
...
fs_compact_median_calc <- function(X, index, unit=NULL){
